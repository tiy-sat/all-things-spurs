        ...
        <div> <p className="featured_post"> FEATURED POSTS </p> </div>
          <article className="blog">
            ...
            <div className="bottom">
              ...
              <p className="blogpost"> The Spurs didn't have many shots fall for them in the first half against the Hornets, but a third quarter run led by the reserves, namely Davis Bertans, pushed the home team ahead, and the fourth quarter turned it into another laugher as San Antonio outscored Charlotte by 20 after intermission.
